...
<div class="container">
	<div id="headersite">
		...
		<div id="login-status" class="floatRight">
			...
			'items'=>array(
				...
				array('label'=>Yii::t('app','Log In'), 'url'=>array('/site/login'), 'visible'=>Yii::app()->user->isGuest),
				array('label'=>Yii::t('app','Log Out ({name})',array('{name}'=>Yii::app()->user->fullname)), 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest)
			)));
			?>
		</div>
		<div class="clear"></div>
	...
	<div class="image-container">
		<img src="<?php echo Yii::app()->request->baseUrl?>/images/front-image.jpg" alt="image" title="image" width="950px" />
	</div>
	<div id="top-menu">
	<div class="container">
