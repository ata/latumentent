...
<?php $pluralize = $this->pluralize($this->class2name($this->modelClass)); ?>
<h2><?php echo "<?php echo Yii::t('app','Manage {$pluralize}'); ?>"?></h2>
...
<?php echo "<?php \$this->renderPartial('_search',array(
	'{$this->singularName}'=>\${$this->singularName},
)); ?>\n"; ?>
</div><!-- search-form -->

<?php echo "<?php"; ?> $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'<?php echo $this->class2id($this->modelClass); ?>-grid',
	'dataProvider'=>$<?php echo $this->singularName; ?>->search(),
	'filter'=>$<?php echo $this->singularName; ?>,
	'columns'=>array(
<?php
$count=0;
